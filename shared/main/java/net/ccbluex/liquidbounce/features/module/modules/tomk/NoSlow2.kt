...
//import cc.paimon.utils.PacketUtils2
...
@ModuleInfo(name = "NoSlow2", description = "Cancels slowness effects caused by soulsand and using items.",
        category = ModuleCategory.MOVEMENT)
class NoSlow2 : Module() {

    private val modeValue = ListValue("PacketMode", arrayOf("None",  "GrimAC", "HuaYuTing",     "Vanilla","NoPacket","AAC","AAC5", "Matrix", "Vulcan", "Custom","Grim","Hytnew","Real"), "AntiCheat")
    ...
    private val cancel = BoolValue("cancel", false)
