...
@ModuleInfo(name = "HytNoHurt", description = "Rion Teams Fix", category = ModuleCategory.HYT)
                ...
                "4v4/1v1", "32/64" -> {
                    ...
                    if (matcher.find()) {
                        ...
                        if (name != "") {
                            ...
                            if (debug.get()) {
                                ClientUtils.displayChatMessage("§8[§b§lRion提醒您§8]§c§d添加无敌人：" + name)
                            }
                            Thread {
                                try {
                                    Thread.sleep(5000)
                                    ...
                                    if (debug.get()) {
                                        ClientUtils.displayChatMessage("§8[§b§lRion提醒您§8]§c§d删除无敌人：" + name)
                                    }
