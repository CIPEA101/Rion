...
class ScoreboardElement(x: Double = 5.0, y: Double = 0.0, scale: Float = 1F,
    ...
    private val domainFontValue = FontValue("DomainFont", Fonts.font35)
    ...
    override fun drawElement(): Border? {
        ...
        val scoreboard: IScoreboard = objective.scoreboard
        ...
        for (score in scoreCollection) {
            ...
            var name = functions.scoreboardFormatPlayerName(scorePlayerTeam, score.playerName)
        ...
        if (scoreCollection.size > 0) { // only draw background and rect whenever there's something on scoreboard
                ...
                ShadowUtils.shadow(shadowStrength.get(), {
                    ...
                    if (bgRoundedValue.get())
                        RenderUtils.originalRoundedRect(
                            ...
                            (maxHeight + fontRenderer.fontHeight).toFloat(), roundStrength.get(),
                ...
                if (bgRoundedValue.get()) {
                    if (side.horizontal == Side.Horizontal.LEFT)
                        BlurUtils.blurAreaRounded(renderX.toFloat() + (l1 + 2F) * scale, renderY.toFloat() + -2F * scale,
                            renderX.toFloat() + -5F * scale, renderY.toFloat() + (maxHeight + fontRenderer.fontHeight) * scale, roundStrength.get(), blurStrength.get())
                    else
                        BlurUtils.blurAreaRounded(renderX.toFloat() + (l1 - 2F) * scale, renderY.toFloat() + -2F * scale,
                            renderX.toFloat() + 5F * scale, renderY.toFloat() + (maxHeight + fontRenderer.fontHeight) * scale, roundStrength.get(), blurStrength.get())
                } else {
                    if (side.horizontal == Side.Horizontal.LEFT)
                        BlurUtils.blurArea(renderX.toFloat() + (l1 + 2F) * scale, renderY.toFloat() + -2F * scale,
                            renderX.toFloat() + -5F * scale, renderY.toFloat() + (maxHeight + fontRenderer.fontHeight) * scale, blurStrength.get())
                    else
                        BlurUtils.blurArea(renderX.toFloat() + (l1 - 2F) * scale, renderY.toFloat() + -2F * scale,
                            renderX.toFloat() + 5F * scale, renderY.toFloat() + (maxHeight + fontRenderer.fontHeight) * scale, blurStrength.get())
                }
            ...
            if (useVanillaBackground.get()) {
                if (side.horizontal == Side.Horizontal.LEFT) {
                    Gui.drawRect(l1 + 2, -2, -5, -2 + fontRenderer.fontHeight + 1, 1610612736)
                    Gui.drawRect(l1 + 2, -2 + fontRenderer.fontHeight + 1, -5, maxHeight + fontRenderer.fontHeight, 1342177280)
                } else {
                    Gui.drawRect(l1 - 2, -2, 5, -2 + fontRenderer.fontHeight + 1, 1610612736)
                    Gui.drawRect(l1 - 2, -2 + fontRenderer.fontHeight + 1, 5, maxHeight + fontRenderer.fontHeight, 1342177280)
                }
            } else if (side.horizontal == Side.Horizontal.LEFT)
                Gui.drawRect(l1 + 2, -2, -5, maxHeight + fontRenderer.fontHeight, backColor)
            else
                Gui.drawRect(l1 - 2, -2, 5, maxHeight + fontRenderer.fontHeight, backColor)
                ...
                for (z in 0..(name.length-1)) {
                    ...
                    if (side.horizontal == Side.Horizontal.LEFT) {
                        when (domainShadowValue.get().toLowerCase()) {
                            ...
                            "default" -> domainFontValue.get().drawStringWithShadow(name.get(z).toString(),
                                (-3F + domainFontValue.get().getStringWidth(stringZ).toFloat()).toInt(),
                                (height.toFloat() + domainFontYValue.get()).toInt(), typeColor)
                            "outline" -> {
                        ...
                        when (domainShadowValue.get().toLowerCase()) {
                            ...
                            "default" -> domainFontValue.get().drawStringWithShadow(name.get(z).toString(),
                                (l1.toFloat() + domainFontValue.get().getStringWidth(stringZ)).toInt(),
                                (height.toFloat() + domainFontYValue.get()).toInt(), typeColor)
                            "outline" -> {
        ...
        return if (side.horizontal == Side.Horizontal.LEFT) Border(maxWidth.toFloat() + 5, -2F, -5F, maxHeight.toFloat() + fontRenderer.fontHeight) else Border(-maxWidth.toFloat() - 5, -2F, 5F, maxHeight.toFloat() + fontRenderer.fontHeight)
    }
