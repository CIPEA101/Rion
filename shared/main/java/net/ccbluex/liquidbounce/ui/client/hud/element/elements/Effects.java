...
public class Effects  extends Element {
    ...
    public Border drawElement() {
        ...
        RenderUtils.drawRoundedRect(-5F,-5F,animationX  + 2F +  Fonts.font35.getStringWidth("Effects"),animationY  + Fonts.font35.getFontHeight(),5F, new Color(32, 30, 30,50).getRGB());
