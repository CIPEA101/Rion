...
import static tomk.render.VisualUtils.quickPolygonCircle;
...
public final class RenderUtils extends MinecraftInstance {
    ...
    private static void gradientSideways(double x, double y, double width, double height, boolean b, Color color1, Color color2) {
    }
}